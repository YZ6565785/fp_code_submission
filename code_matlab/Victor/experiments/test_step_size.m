...
%% test step size
parameter_list = 0.05:0.01:0.13;
n_to_run = 1;
test_type = "step_size";
overwrite = false

for para = parameter_list
    test_results = []
    for i = 1:n_to_run 
        qs =[];
        while isempty(qs)
...
%%
clear all
[test_para, data_loaded] = Helpers.load_test_results("step_size")
...
title("Average Distance, Time, and Number of Samples by Step Size in 10 Runs")
...
if false
    f = figure(1)
    saveas(f, "../UCL Final Project/figures/exp/test_step_size.png", 'png') 
end