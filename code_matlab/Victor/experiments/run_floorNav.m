...
if false
    f = figure(2)
    saveas(f, "../UCL Final Project/figures/exp/floorNav_method3d.png", 'png') 
end
%% KDTree version
figure(2);clf
...
>>>>>>> ad45b54eb395a879e2b0054208caa9cb13947f0b
rrt.min_timeout =40;
rrt.t_timeout =50;
rrt.e_inc = 0.01;
rrt.e_reach = 0.12;
...
if false
    saveas(f, "../UCL Final Project/figures/exp/floorNav_method3d_progress.png", 'png') 
    
    save('Victor/data/path_saved/floorNav_method3d.mat','p');
end