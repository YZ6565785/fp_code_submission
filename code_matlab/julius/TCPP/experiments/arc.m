...
if false
    f = figure(2)
    saveas(f, "../UCL Final Project/figures/exp/planar_arc_julius.png", 'png') 
end
%%
...
ids=ceil(linspace(1,length(path),2));
...
if false
    f = figure(9)
    saveas(f, "../UCL Final Project/figures/exp/planar_arc_julius_progress.png", 'png') 
end