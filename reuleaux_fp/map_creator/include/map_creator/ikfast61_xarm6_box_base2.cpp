...
///
/// ikfast version 0x1000004a generated on 2021-08-17 14:39:09.623958
...
IkReal x59=((1.0)*x27);
IkReal x60=((1.0)*x12);
eetrans[0]=((0.18)+((x0*x14))+((x0*x15))+(((-1.0)*x25*x32))+(((-1.0)*x31*x59))+((x10*(((((-0.097)*x49))+(((-0.097)*x34))))))+((x10*(((((-1.0)*x31*x60))+(((-1.0)*x29*x60))))))+(((-1.0)*x29*x59))+((x25*x30))+((x9*((((x21*x43))+(((0.076)*x34))))))+((x9*(((((-1.0)*x31*x58))+(((-1.0)*x29*x58)))))));
...
eetrans[2]=((0.394)+(((-0.0535)*x7))+((x9*(((((-0.097)*x30))+(((0.097)*x32))))))+(((-0.0775)*x31))+((x10*(((((0.076)*x32))+(((-0.076)*x30))))))+((x35*(((((-1.0)*x37))+(((-0.076)*x29))))))+(((0.3425)*x32))+(((0.2845)*x4))+(((-0.0775)*x29))+(((-0.3425)*x30))+((x28*(((((0.097)*x29))+(((0.097)*x31)))))));
}
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - xarm6_box_base2 (655c639fda63e00239470cf3034cedab)>"; }
