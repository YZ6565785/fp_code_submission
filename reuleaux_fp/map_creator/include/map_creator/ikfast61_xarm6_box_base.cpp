...
///
/// ikfast version 0x1000004a generated on 2021-08-11 00:00:01.741996
...
IkReal x61=((1.0)*x29);
IkReal x62=((1.0)*x31);
eetrans[1]=((0.08)+(((-1.0)*x13*x62))+(((-1.0)*x13*x61))+((x1*x15))+((x1*x14))+((x17*x30))+((x10*(((((-1.0)*x1*x37))+(((-0.076)*x1*x29))))))+((x10*(((((-0.097)*x50))+((x2*x26))))))+((x9*((((x21*x44))+(((-0.076)*x33))))))+(((-1.0)*x17*x32))+((x9*(((((-1.0)*x23*x61))+(((-1.0)*x23*x62)))))));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - xarm6_box_base (31538a39a9d12dc4209194478aca2beb)>"; }
