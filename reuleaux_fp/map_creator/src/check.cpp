...
int main(int argc, char **argv)
{
  ...
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, 0.19, 0.0, 0.0, 0.0}, false));
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, 0.0, 0.0, 1.33, 0.0}, false));
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, 0.0, 0.0, 1.31, 0.0}, false));
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, 0.0, 0.0, 1.30, 0.0}, false));
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.83, -0.36, 0.0, 0.0, 0.0}, false));
