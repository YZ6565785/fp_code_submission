...
int main(int argc, char **argv)
{
  ...
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, -0.43, 0.0, 1.75, 0.0}, true));
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, -0.44, 0.0, 1.75, 0.0}, true));
  test_joint_values.push_back(std::make_pair(std::vector<double>{0.0, 0.0, -0.45, 0.0, 1.75, 0.0}, false));
