# reuleaux - Modified Branch

## This is a modified version of the original realeaux which is tested to work on Ubuntu ROS Melodic devel. 
## Victor (Yuhang) Zhang, 09 2021
### For UCL Final Project 

* added new feature to compute RM with self collision checking.
* also stores the boolean variable results of the sampled poses per sphere.
* uses uniformly distributed sampling poses on each sphere, z-axis of the pose orientation is along the unit vectors. The original sampling poses is random and bad.
